...
class URLTests(TestCase):
    def setUp(self):
        ...
        self.urls = {
            'index': UrlAndTemplate(url='/', template='index.html'),
            'info_page': UrlAndTemplate(
                url='/info_page/', template='info.html'
            ),
            'about': UrlAndTemplate(url='/about/', template='about.html'),
            'archive': UrlAndTemplate(
                url='/archive/', template='archive.html'
            ),
